...
class ResnetSteganoGAN(tf.keras.Model):
  def __init__(self, encoder=None, decoder=None, critic=None, data_depth=6, critic_extra_steps=5):
  ...
  def train_step(self, data):
    ...
    for _ in range(self.critic_extra_steps):
      with tf.GradientTape() as critic_tape:
        ...
        critic_loss = self.critic_loss_fn(cover_critic_scores, stego_critic_scores)
